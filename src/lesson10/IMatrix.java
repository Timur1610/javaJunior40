...
public interface IMatrix {
	 ...
	 */
	int getRows(); //вернуть количество строк в матрице
	 ...
	 */
	int getColumns(); //вернуть количество колонок в матрице
	 ...
	 */
	double getValueAt(int rowIndex, int colIndex) throws IndexOutOfBoundsException; //вернуть значение по позиции
	 ...
	 * 			или индекс столбца меньше нуля или больше (или равно) количества столбцов матрицы
	 */
	void setValueAt(int rowIndex, int colIndex, double value) throws IndexOutOfBoundsException; //установить значение по индексам
	 ...
	 */
	IMatrix add(IMatrix otherMatrix) throws IllegalArgumentException, NullPointerException; //сложение матриц
	 ...
	 * @throws NullPointerException если второй аргумент null
	 */
	IMatrix sub(IMatrix otherMatrix) throws IllegalArgumentException, NullPointerException; //вычитание матриц
	 ...
	 * @throws NullPointerException если второй аргумент null
	 */
	IMatrix mul(IMatrix otherMatrix) throws IllegalArgumentException, NullPointerException; //умножение матриц
	 ...
	 */
	IMatrix mul(double value); // всю матрицу умножить на определенное число
	 ...
	 */
	IMatrix transpose(); //ложить матрицу по диагонали
